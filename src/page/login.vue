<template>
    <div class="page-login">
        <div class="login-header">
            <a class = "logo" href="https://cd.meituan.com/"></a>
        </div>
        <div class="login-panel">
            ...
            <div class="form">
                ...
                <p><span>账号登录</span></p>
                <el-input :class="{error:error && !username}" v-model="username" type = "text" prefix-icon = "profile" placeholder="手机号/账户/邮箱登陆"></el-input>
                <el-input :class="{error:error && !password}" v-model="password" type = "password" prefix-icon = "password" placeholder="请输入密码"></el-input>
                <div class="foot">
